...
class OffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create offer" do
    assert_difference('Offer.count') do
      post offers_url, params: { offer: { ccr_id: @offer.ccr_id, major_id: @offer.major_id } }
    end
  ...
  test "should update offer" do
    patch offer_url(@offer), params: { offer: { ccr_id: @offer.ccr_id, major_id: @offer.major_id } }
